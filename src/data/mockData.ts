...
export const portfolio = [
  {
    ...
    description:
      "Advanced exploration site in Madagascar's eastern gold belt, featuring high-grade alluvial and hard-rock deposits.",
    image:
  ...
  },
  {
    ...
    description:
      "Large-flake graphite processing operations supplying battery anode and industrial refractory markets.",
    image:
  ...
  },
  {
    ...
    description:
      "Helicopter-borne geophysical surveys covering over 5,000 km\u00b2 of prospective terrain in the eastern belt.",
    image:
  ...
  },
  {
    ...
    category: "Mineral Samples",
    description:
      "Certified sample preparation and assay laboratory for gold, lithium, REE and base metal analysis.",
    image:
  ...
  },
  {
    ...
    description:
      "Building lasting partnerships with local communities through education, healthcare and infrastructure initiatives.",
    image:
  ...
  },
  {
    ...
    description:
      "Post-mining land rehabilitation programs ensuring long-term environmental stewardship and biodiversity protection.",
    image:
  ...
  },
  {
    ...
    description:
      "Building reliable access roads, power supply and logistics networks to support mining operations.",
    image:
