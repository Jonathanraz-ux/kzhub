...
export const fr: TranslationKeys = {
  ...
  bioLabel: "Biographie & Leadership",
  bioTitle: "Direction Stratégique & Engagement Client",
  bioSubtitle: "Kazak Mining Hub est une division de Kazak Ltd., société de développement commercial opérant à Madagascar.",
  bioDesc1: "Opérant à travers des secteurs stratégiques — tels que l'agriculture, l'éducation, la technologie et les mines — Kazak Ltd. connecte les investisseurs internationaux avec des opportunités d'affaires à haut potentiel dans l'un des pays les plus riches en ressources minérales d'Afrique.",
  bioDesc2: "Reconnaissant la richesse minérale exceptionnelle de l'île, Kazak Mining Hub sert de partenaire local de confiance. Nous accompagnons nos clients avant, pendant et après l'acquisition de leurs projets miniers pour transformer le potentiel géologique en investissements rentables et durables.",
